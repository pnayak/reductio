...
function accessor_build(obj, p) {
  ...
  obj.ratio = function(value, field, filterValue) {
    if (!arguments.length) return p.ratio;
    p.ratio = value;
    p.ratioField = field;
    p.ratioFilterValue = filterValue;
    // console.log("### accessors: customjs() - returning obj = %o p.customjs = %o", obj, p.customjs);
    return obj;
  };

  obj.ratioBoCFirst = function(value, field, filterValue, depField, sortField) {
    if (!arguments.length) return p.ratioBoCFirst;
    p.ratioBoCFirst = value;
    p.ratioBoCFirstField = field;
    p.ratioBoCFirstFilterValue = filterValue;
    p.ratioBoCFirstDepField = depField;
    p.ratioBoCFirstSortField = sortField;
    // console.log("### accessors: ratioBoCFirst ");
    return obj;
  };

  obj.ratioBoCLatest = function(value, field, filterValue, depField, sortField) {
    if (!arguments.length) return p.ratioBoCLatest;
    p.ratioBoCLatest = value;
    p.ratioBoCLatestField = field;
    p.ratioBoCLatestFilterValue = filterValue;
    p.ratioBoCLatestDepField = depField;
    p.ratioBoCLatestSortField = sortField;
...
},{"./alias.js":4,"./aliasProp.js":5,"./avg.js":6,"./count.js":9,"./customjs.js":10,"./data-list.js":11,"./exception-count.js":12,"./exception-sum.js":13,"./filter.js":14,"./histogram.js":15,"./max.js":16,"./median.js":17,"./min.js":18,"./nest.js":19,"./ratio.js":23,"./ratioBoCFirst.js":24,"./ratioBoCLatest.js":25,"./std.js":27,"./sum-of-squares.js":28,"./sum.js":29,"./value-count.js":30,"./value-list.js":31}],8:[function(require,module,exports){
...
},{"./cap":8,"./sortBy":26}],23:[function(require,module,exports){
...
},{"lodash":2}],24:[function(require,module,exports){
var _ = require('lodash');
...
},{"lodash":2}],26:[function(require,module,exports){
